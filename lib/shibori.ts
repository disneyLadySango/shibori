...
type PromptInput = { context: UserContext; material: string; gaps: GapEntry[]; focusResource: FocusResource; learningPosition: LearningPosition };
type EvaluationPromptInput = { context: UserContext; problem: string; answer: string };

export function buildProjectionPrompt({ context, material, gaps, focusResource, learningPosition }: PromptInput) {
...
export function createDemoProjection(context: UserContext, gaps: GapEntry[], focusResource: FocusResource): Projection {
