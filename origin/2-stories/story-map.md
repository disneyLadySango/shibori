...
Slice A、Slice B、Slice A2の最初の承認済み境界は実装済みである。ラストスパートでは残る15ストーリーを取りこぼさず、次の四つの実装波へまとめる。

1. 判断の誠実性と訂正: US-019, US-022, US-028, US-016, US-029
2. 理解確認後の前進: US-023, US-024, US-030, US-015
3. 状況変化への適応: US-014, US-018, US-020, US-031
4. 到達と配分の判断: US-027, US-009

15ストーリーのACと45テスト仕様は人間が一括承認済みである。Wave 4のUS-027、US-009までactive化し、確認結果に基づく到達判断と、投入量と到達への接近を分けた配分判断を射影へ取り込んだ。四つの実装波はすべてactiveである。

国際審査向けの公開デモではUS-032を横断スライスとして追加し、英語と日本語の対話言語を学習状態から独立して選べるようにする。
...
- revision 15, 2026-07-21: 残る15ストーリーを全件取り込むラストスパートとして、判断の誠実性と訂正、理解確認後の前進、状況変化への適応、到達と配分の判断の四つの実装波へ再編。
- revision 16, 2026-07-21: 人間が残る15 ACと45テスト仕様を一括承認。Wave 1の判断の誠実性と訂正をactive化。
- revision 17, 2026-07-21: Wave 2の理解確認後の前進をactive化し、次の一手、限定した再挑戦、抜け一件の優先、前提関係の説明を射影へ取り込む。
- revision 18, 2026-07-21: Wave 3の状況変化への適応をactive化し、残りの区別、生活リズム更新、集中先の拒否、到達状態の見直しを射影へ取り込む。
- revision 19, 2026-07-21: Wave 4の到達と配分の判断をactive化し、承認済みラストスパート15ストーリーの射影取り込みを完了。
- revision 20, 2026-07-22: US-032を横断関心へ追加し、対話言語を越えて判断できる公開デモの境界を承認。
